...
public class CustomerApiClient extends BaseApiClient {
    ...
    public CustomerDTO createCustomer(CustomerDTO newCustomerDTO) throws IOException, InterruptedException, ApiClientException {
        String requestBody = gson.toJson(newCustomerDTO);
    ...
    public void updateCustomer(CustomerDTO customerDTO) throws IOException, InterruptedException, ApiClientException {
        String requestBody = gson.toJson(customerDTO);

        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(API_BASE_URL + "/customers/" + customerDTO.getId()))
                .header("Content-Type", "application/json")
    ...
    public void deleteCustomer(long customerId) throws IOException, InterruptedException, ApiClientException {
        HttpRequest request = HttpRequest.newBuilder()
